...
var hs300child_1 = __importDefault(require("./hs300child"));
var HS300 = /** @class */ (function (_super) {
    __extends(HS300, _super);
    function HS300(tpLink, deviceInfo) {
        var _this = _super.call(this, tpLink, deviceInfo) || this;
        _this.tpLink = tpLink;
        _this.genericType = "switch";
        return _this;
    }
    HS300.prototype.getChildren = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        r = _a.sent();
                        return [2 /*return*/, (this.children = r.children)];
                }
            });
        });
    };
    HS300.prototype.findChild = function (alias) {
        var child;
        if (alias && this.children) {
            // we first search a correspondig device by alias
            child = this.children.find(function (d) { return d.alias === alias; });
            // we then search a correspondig device by deviceId
            if (!child) {
                child = this.children.find(function (d) { return d.id === alias; });
            }
        }
        if (!child) {
    ...
    HS300.prototype.getChild = function (alias) {
        return new hs300child_1.default(this.tpLink, this.device, this.findChild(alias));
    };
    return HS300;
}(hs100_1.default));
exports.default = HS300;
//# sourceMappingURL=hs300.js.map
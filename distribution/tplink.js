...
var hs300_1 = __importDefault(require("./hs300"));
var lb100_1 = __importDefault(require("./lb100"));
var lb120_1 = __importDefault(require("./lb120"));
...
var TPLink = /** @class */ (function () {
    ...
    TPLink.prototype.newDevice = function (nameOrInfo) {
        ...
        if (type.includes("bulb")) {
            ...
            if (model && model.includes("120")) {
                return new lb120_1.default(this, deviceInfo);
            }
    ...
    TPLink.prototype.findDevice = function (alias) {
        ...
        if (alias && this.deviceList) {
            ...
            if (!deviceInfo) {
                deviceInfo = this.deviceList.find(function (d) { return d.deviceId === alias; });
            }
        }
        if (!deviceInfo) {
    ...
    TPLink.prototype.getHS300 = function (alias) {
        return new hs300_1.default(this, this.findDevice(alias));
    };
    ...
    TPLink.prototype.getKL110 = function (alias) {
        return this.getLB100(alias);
    };
    TPLink.prototype.getKL50 = function (alias) {
        return this.getLB100(alias);
    };
    TPLink.prototype.getKL60 = function (alias) {
        return this.getLB100(alias);
    };
    // for an LB120, KL120 lightbulb (dimmable, tunable white)
    TPLink.prototype.getLB120 = function (alias) {
        return new lb120_1.default(this, this.findDevice(alias));
    };
    TPLink.prototype.getKL120 = function (alias) {
    ...
    TPLink.prototype.getKB130 = function (alias) {
        return this.getLB130(alias);
    };
    TPLink.prototype.getKL130 = function (alias) {
        return this.getLB130(alias);
    };
    return TPLink;
}());
